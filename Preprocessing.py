...
name_pos_dict = {}
pos_set = set()
with open('./IS517_Project-main/player_position.csv', 'r', encoding='utf-8', newline='') as all_final_f:
...
player_set = set()
id_set = set()
with open('./IS517_Project-main/players.csv', 'r', newline='') as players_f:
    with open('ANNO_Players.csv', 'w', newline='') as anno_player_f:
...
name_set = set()
left_id_set = set()
with open('./IS517_Project-main/games_details.csv', 'r', newline='') as game_details_f:
